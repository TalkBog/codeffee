...
export default function page() {
  ...
  function addError() {
    setNotices((n) => [
      ...n,
      { type: "error", message: "Cette adresse n'est pas disponible" },
    ]);
  }
  ...
  function addSuccess() {
    setNotices((n) => [
      ...n,
      {
        type: "success",
        message:
          "Votre inscription a bien été prise en compte. Valider votre adresse email pour vous connecter.",
      },
    ]);
  }
  ...
  return (
    <>
      <Heading as="h1" size="md" variant="black" weight="bold" className="mb-4">
        Inscription
      </Heading>
